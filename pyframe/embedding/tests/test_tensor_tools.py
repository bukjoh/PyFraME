...
def test_compute_interaction_tensor_element():
    ...
    multi_indices_1 = (0, 0, 0)
    assert math.isclose(0.0658436437005385, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ij,
                                                                                            tensor_coefficient))
    assert math.isclose(0.0658436437005385, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ji,
                                                                                            tensor_coefficient))
    # 1st order derivatives
    multi_indices_1 = (1, 0, 0)
    multi_indices_2 = (0, 1, 0)
    multi_indices_3 = (0, 0, 1)
    assert math.isclose(0.0023122063382223267, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ij,
                                                                                               tensor_coefficient))
    assert math.isclose(-0.0023122063382223267, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ji,
                                                                                                tensor_coefficient))
    assert math.isclose(0.0019411114938162743, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ij,
                                                                                               tensor_coefficient))
    assert math.isclose(-0.0019411114938162743, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ji,
                                                                                                tensor_coefficient))
    assert math.isclose(0.0031114875415584396, tensor_tools.compute_interaction_tensor_element(multi_indices_3, r_ij,
                                                                                               tensor_coefficient))
    assert math.isclose(-0.0031114875415584396, tensor_tools.compute_interaction_tensor_element(multi_indices_3, r_ji,
                                                                                                tensor_coefficient))
    # 2nd order derivatives
    multi_indices_1 = (2, 0, 0)
    multi_indices_2 = (1, 0, 1)
    multi_indices_3 = (0, 1, 1)
    multi_indices_4 = (0, 0, 2)
    ...
    assert math.isclose(-4.1866945641792955e-5, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ji,
                                                                                                tensor_coefficient))
    assert math.isclose(0.00032779479432875263, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ij,
                                                                                                tensor_coefficient))
    assert math.isclose(0.00032779479432875263, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ji,
                                                                                                tensor_coefficient))
    assert math.isclose(0.0002751857532636442, tensor_tools.compute_interaction_tensor_element(multi_indices_3, r_ij,
                                                                                               tensor_coefficient))
    assert math.isclose(0.0002751857532636442, tensor_tools.compute_interaction_tensor_element(multi_indices_3, r_ji,
                                                                                               tensor_coefficient))
    assert math.isclose(0.00015564900246433047, tensor_tools.compute_interaction_tensor_element(multi_indices_4, r_ij,
                                                                                                tensor_coefficient))
    assert math.isclose(0.00015564900246433047, tensor_tools.compute_interaction_tensor_element(multi_indices_4, r_ji,
                                                                                                tensor_coefficient))
    # 3rd order derivatives
    multi_indices_1 = (0, 3, 0)
    multi_indices_2 = (1, 1, 1)
    multi_indices_3 = (0, 1, 2)
    ...
    assert math.isclose(5.0433694213263545e-5, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ji,
                                                                                               tensor_coefficient))
    assert math.isclose(4.831797020366597e-5, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ij,
                                                                                              tensor_coefficient))
    assert math.isclose(-4.831797020366597e-5, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ji,
                                                                                               tensor_coefficient))
    ...
    multi_indices_1 = (2, 2, 0)
    multi_indices_2 = (1, 2, 1)
    multi_indices_3 = (0, 0, 4)
    assert math.isclose(2.1207330998015187e-6, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ij,
                                                                                               tensor_coefficient))
    assert math.isclose(2.1207330998015187e-6, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ji,
                                                                                               tensor_coefficient))
    assert math.isclose(2.8655224575164097e-6, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ij,
                                                                                               tensor_coefficient))
    assert math.isclose(2.8655224575164097e-6, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ji,
                                                                                               tensor_coefficient))
    assert math.isclose(-1.1756644987695054e-5, tensor_tools.compute_interaction_tensor_element(multi_indices_3, r_ij,
                                                                                                tensor_coefficient))
    assert math.isclose(-1.1756644987695054e-5, tensor_tools.compute_interaction_tensor_element(multi_indices_3, r_ji,
                                                                                                tensor_coefficient))
    # 5th order derivatives
    multi_indices_1 = (2, 1, 2)
    multi_indices_2 = (1, 1, 3)
    assert math.isclose(2.5358289633406297e-6, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ij,
                                                                                               tensor_coefficient))
    assert math.isclose(-2.5358289633406297e-6, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ji,
                                                                                                tensor_coefficient))
    assert math.isclose(2.3986145397364605e-6, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ij,
                                                                                               tensor_coefficient))
    assert math.isclose(-2.3986145397364605e-6, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ji,
                                                                                                tensor_coefficient))
    # 10th order derivatives
    multi_indices_1 = (5, 2, 3)
    multi_indices_2 = (3, 6, 1)
    assert math.isclose(-2.4842594513699081e-8, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ij,
                                                                                                tensor_coefficient))
    assert math.isclose(-2.4842594513699081e-8, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ji,
                                                                                                tensor_coefficient))
    assert math.isclose(-5.4055195481204153e-9, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ij,
                                                                                                tensor_coefficient))
    assert math.isclose(-5.4055195481204153e-9, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ji,
                                                                                                tensor_coefficient))
    # 21st order derivatives
    multi_indices_1 = (13, 3, 5)
    multi_indices_2 = (7, 7, 7)
    assert math.isclose(-7.5730234910186237e-9, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ij,
                                                                                                tensor_coefficient))
    assert math.isclose(7.5730234910186237e-9, tensor_tools.compute_interaction_tensor_element(multi_indices_1, r_ji,
                                                                                               tensor_coefficient))
    assert math.isclose(9.8765395046408577e-10, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ij,
                                                                                                tensor_coefficient))
    assert math.isclose(-9.8765395046408577e-10, tensor_tools.compute_interaction_tensor_element(multi_indices_2, r_ji,
                                                                                                 tensor_coefficient))
    # second test
    r = np.array([2, 0, 0])
    multi_indices_1 = (0, 0, 0)
    multi_indices_2 = (1, 0, 0)
    multi_indices_3 = (0, 1, 0)
    multi_indices_4 = (3, 0, 0)

    null_derivative_element = tensor_tools.compute_interaction_tensor_element(multi_indices_1, r, tensor_coefficient)
    assert null_derivative_element == 0.5

    first_derivative_x_element = tensor_tools.compute_interaction_tensor_element(multi_indices_2, r, tensor_coefficient)

    assert first_derivative_x_element == -0.25

    first_derivative_y_element = tensor_tools.compute_interaction_tensor_element(multi_indices_3, r, tensor_coefficient)
    assert first_derivative_y_element == 0.0

    third_derivative_x_element = tensor_tools.compute_interaction_tensor_element(multi_indices_4, r, tensor_coefficient)
