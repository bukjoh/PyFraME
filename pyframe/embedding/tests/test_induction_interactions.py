...
def test_compute_induction_energy(wat_wat,
    ...
    env_wat = wat_wat[1]
    induced_dipoles_wat = wat_wat_ind_dip
    nuclear_fields = np.array([[-0.199083, -0.47195685, -0.06765254],
    ...
    electric_fields = np.array([[0.19711192, 0.43265575, 0.05777407],
    ...
    env_acrolein = acrolein_wat[1]
    induced_dipoles_acrolein = acrolein_wat_ind_dip
    nuclear_fields = np.array([[6.12879109e-01, -1.55417637e-02, 1.73067342e-04],
    ...
    electric_fields = np.array([[-6.16582892e-01, 1.07395149e-02, -1.75560439e-04],
