...
class TestQuantumSubsystem:
    ...
    def test_compute_nuclear_fields(self):
        ref_array = -1.0 * np.array([[0.00392044, -0.05293017, -0.10427627],
    ...
    def test_compute_nuclear_field_gradients(self):
        ref_grads = -1.0 * np.array([9.5311929756771267e-3, 7.7985188788112876e-3, -1.0495468203592808e-6,
        ...
        ref_grads = -1.0 * np.array([[[9.53119298e-03, 7.79851888e-03, -1.04954682e-06,
...
class TestClassicalSubsystem:
    ...
    def test_compute_multipole_fields(self):
        ref_fields = -1.0 * np.array([[-6.88526592e-03, 8.61243977e-03, -3.98239429e-03],
        ...
        ref_fields = -1.0 * np.array([[-6.43939331e-03, -1.75558132e-03, 7.58932558e-04],
    ...
    def test_solve_induced_dipoles(self,
        ...
        int_driver = dummy_integral_driver_factory(-1.0 * act_wat_electric_fields)
        ...
        ref_dipoles = -1.0 * np.array([[-0.05130705, -0.25165223, -0.4511121],
