...
__all__ = ['BOHR2AA', 'AA2BOHR', 'element2radius', 'element2charge', 'element2mass', 'compute_angle',
           ...
           'get_bond_length', 'scale_bond_length', 'get_version_string']
...
amino_acid_names = [prefix + name for name in ['ALA','ARG','ASN', 'ASH', 'ASP', 'CYM', 'CYS', 'CYX', 'GLH', 'GLN','GLU','GLY', 'HID', 'HIE', 'HIS', 'HSD', 'HSE', 'ILE','LEU', 'LYN','LYS','MET','PHE','PRO','SER','THR','TRP','TYR','VAL','ACE','NME'] for prefix in ['', 'N', 'n', 'C', 'c', 'A', 'B']]
...
def get_version_string():
    ...
    if git_hash:
        git_hash = ", git revision " + git_hash
    return f'Generated by PyFraME (version {pyframe.__version__}{git_hash})'
